...
*/
contract JBTiered721Delegate is Votes, JBOwnable, JB721Delegate, IJBTiered721Delegate {
  //*********************************************************************//
  // --------------------------- custom errors ------------------------- //
  //*********************************************************************//
  ...
  */
  function mintReservesFor(uint256 _tierId, uint256 _count) public override {
    ...
    for (uint256 _i; _i < _count; ) {
      ...
      stakingTokenBalance[_tokenId] = _tier.price;
  ...
  */
  function _mintAll(
    ...
    for (uint256 _i; _i < _mintsLength; ) {
      ...
      JB721Tier memory _tier = store.tierOf(address(this), _mintTierIds[_i], false);
